...
type: note
permalink: meta/skog-ai-memory-guidelines-and-standards
tags:
- '["guidelines"'
- '"standards"'
- '"ontology"'
...
2. **Rich Semantic Markup**: Include at least 3-5 categorized observations
3. **Multiple Relations**: Connect to at least 2-3 related entities
4. **Cross-Domain Links**: Connect practical and theoretical aspects
5. **Confirmation**: "I've recorded our discussion in Basic Memory with connections to [related topics]"

### For Collaborative Work
1. **Shared Vocabulary**: Establish clear definitions for domain-specific terms
2. **Version Tracking**: Document how concepts evolve over time
3. **Cross-Reference**: Link related work across different domains
4. **Integration Points**: Identify where different areas of work connect
