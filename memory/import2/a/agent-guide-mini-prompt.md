...
type: note
permalink: synthesis/synthesis-of-skogai-memory-agent-guide
---
...
**Common Categories [@file:agent-guide-mini.md] Relation Types:**
...
Above is the knowledge guide for skogai-memory as well as a memory called agent-guide-mini.md

Please return your ratings and what you see as good and bad about the memory agent-guide-mini.md and how it follows the skogai-memory knowledge guide.