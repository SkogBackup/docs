...
### Read [@file:skogai-memory.md] Reference
```
memory://permalink
...
Above is the knowledge guide for skogai-memory as well as a memory called skogai-memory.md

Please return your ratings and what you see as good and bad about the memory skogai-memory.md and how it follows the skogai-memory knowledge guide.