...
---
title: SkogAI-Memory Agent Guide
type: note
permalink: skogai/memory/agent-guide
---
...
**Common Categories [@file:agent-guide.md] Relation Types:**
...
Above is the knowledge guide for skogai-memory as well as a memory called agent-guide.md

Please return your ratings and what you see as good and bad about the memory agent-guide.md and how it follows the skogai-memory knowledge guide.