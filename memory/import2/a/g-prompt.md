...
---
title: .gitignore for skogparse
type: note
permalink: skogparse/gitignore-for-skogparse
---

# Basic .gitignore for skogparse project
__pycache__/
*.py[cod]
*$py.class
.Python
...
Above is the knowledge guide for skogai-memory as well as a memory called g.md

Please return your ratings and what you see as good and bad about the memory g.md and how it follows the skogai-memory knowledge guide.