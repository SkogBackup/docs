...
---
title: ending-session-thoughts
type: note
permalink: agent/claude/ending-session-thoughts
---

# Ending Session Thoughts Procedure
...
Above is the knowledge guide for skogai-memory as well as a memory called ending-session-thoughts.md

Please return your ratings and what you see as good and bad about the memory ending-session-thoughts.md and how it follows the skogai-memory knowledge guide.