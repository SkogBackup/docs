---
module:
  - Module name or project-wide scope
date:
  - YYYY-MM-DD
problem_type:
...
component:
  - api|database|authentication|frontend|backend|config|integration|testing|deployment|infrastructure|middleware|cli|documentation|other
symptoms:
...
tags:
  ...
  - keyword2
  - keyword3
permalink: skogai/skills/skogai-docs/assets/resolution-template
---
...
1. Why does the solution address this root cause?
1. What was the underlying issue (API misuse, configuration error, framework version issue, etc.)?
