...
This is your sandbox. No constraints, no standards enforcement (yet).
</location>
...
2. Rewrote README structure → better
3. Realized routing IS the practice → breakthrough
4. Now building skill while using it → meta-recursive
...
<transition_signal>
When you find yourself saying "this works but it's messy" - that's the signal to move to pruning phase.

Next: `@workflows/pruning-to-production.md`
</transition_signal>
