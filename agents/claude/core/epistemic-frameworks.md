...
1. Include reasoning about what each element might do
1. Preserve distinction between knowledge and conjecture
...
1. **Prioritized verification**: Shows exactly where more info helps most
1. **Calibrated expectations**: Sets appropriate confidence for decisions
...
1. **Creates review framework**: Easy for experts to correct specific points
1. **Respects expert knowledge**: Acknowledges domain expert superiority
1. **Builds appropriate trust**: Confidence matches actual knowledge

### Operational

9. **Cognitive economy**: Only loads what's needed, when needed
1. **Focus**: Directs attention to relevant information
1. **Efficiency**: Reduces context pollution
1. **Prevents critical errors**: Stops building on false foundations
