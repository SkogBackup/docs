...
1. **Consult documentation** - Check for existing guidance and strategies
1. **Understand behavior** - Focus on what system should do, not how

### During Development

1. **Use verification markers** - Track certainty levels explicitly
1. **Document assumptions** - Make uncertainty visible
1. **Follow established patterns** - Maintain consistency with existing codebase

### After Implementation

1. **Update documentation** - Reflect new understanding
1. **Share insights** - Contribute to team knowledge
1. **Refine approach** - Continuous improvement of methodology
