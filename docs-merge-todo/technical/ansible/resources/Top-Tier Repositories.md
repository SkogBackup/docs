...
**URL**: https://github.com/linuxpiper/ansible-arch-setup
**Status**: Active development (2024)
**Focus**: Complete KDE Plasma desktop environment setup
...
**URL**: https://github.com/binary-manu/arch-ansible
**Documentation**: https://binary-manu.github.io/arch-ansible/
**Status**: Highly active with v0.3.x branch
**Focus**: Complete Arch Linux installation from bare metal
...
**URL**: https://github.com/pigmonkey/spark
**Status**: Actively maintained
**Focus**: Comprehensive laptop/desktop provisioning with advanced security
