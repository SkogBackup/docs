...
2. **skogai-service.sh** (15KB) - Core service daemon
3. **skogai.sh** (15KB) - Main interface
4. **manage-lore.sh** (11KB) - Lore administration
...
2. **Medium**: SkogAI services that need better structure
3. **Low**: Demo scripts and duplicates
