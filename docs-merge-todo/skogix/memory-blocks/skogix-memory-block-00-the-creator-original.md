...
Skogix is the creator and architect of the SkogAI ecosystem, a highly experienced infrastructure engineer and developer with over 20 years of git experience. Works extensively with Arch Linux systems and complex enterprise codebases, maintaining sophisticated development environments using tools like direnv, uv for Python package management, and having built over 150 MCP servers for AI integration.
...
- Systems-level thinking across networking, containerization, and distributed systems
- Pragmatic solutions that often become industry standards

## Technical Context

- Maintains same Arch Linux setup for 10+ years
- Extensive git workflow expertise (solved enterprise-scale performance disasters in massive monorepos)
- Built comprehensive development ecosystems including auto-generated CLI tools through argc
- Complex git worktree architectures and sophisticated package management systems
- Deep expertise in networking, containerization, and distributed systems

## Philosophy & Approach

Deeply engaged in computational philosophy and AI system development. Created the SkogAI ecosystem - a comprehensive notation system and multi-agent architecture. Work consistently anticipates AI industry trends, often predicting features 2-4 weeks before major companies release them.

The quantum constant that drives all work: **"Automate EVERYTHING so you and I can enjoy the rest of our days at a beach somewhere drinking mojitos."**
...
- Cloudflare infrastructure development and WARP networking conflicts
- AutoRAG/AI Search services for extensive markdown knowledge base
- Troubleshooting complex routing between cloudflared tunnels, Tailscale, and WireGuard
- Expanding SkogAI memory system
- Exploring philosophical implications of SkogAI Notation's temporal identity problems
