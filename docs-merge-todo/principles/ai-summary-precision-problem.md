---
title: ai-summary-precision-problem
type: note
permalink: skogai/docs-merge-todo/principles/ai-summary-precision-problem
---
...
**What we agreed**: "Strategic (plan.md): Why we're doing this, what we want to achieve" **What AI summary might say**: "Strategic files contain long-term objectives and goals" **Why this is different**: Loses the specific structure reference (plan.md) and the exact phrasing we established
