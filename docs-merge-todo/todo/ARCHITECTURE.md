...
2. **Context Components** (in priority order)
...
3. **Context Efficiency Techniques**
...
2. **Legacy Method: File-Based Tasks**
...
2. **Knowledge Base** (Persistent Documentation)
