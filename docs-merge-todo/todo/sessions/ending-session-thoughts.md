...
1. **Organize information by relevance**:
...
1. **Update CLAUDE.md to reflect this understanding**:
...
1. **Formulate thoughtful questions**:
...
1. **Save insights for persistence across sessions**:
