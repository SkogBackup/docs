...
2. **Type Safety**: Ensure dimensional compatibility in expressions
3. **Consistency Check**: Verify no circular definitions in `$` usage
4. **Capability Respect**: Honor `.` operator security constraints
