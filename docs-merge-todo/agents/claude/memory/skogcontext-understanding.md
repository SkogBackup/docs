...
## Core Problem Solved
Legacy system: hardcoded appending to `./tmp/context.md`
New system: flexible framework for agents to compose their own context generation strategies
...
2. **Agent Tools**: agent-specific context objects that orchestrate static tools
