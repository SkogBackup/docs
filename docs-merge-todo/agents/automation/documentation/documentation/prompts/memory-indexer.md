...
type: note
permalink: skogai/docs-merge-todo/agents/automation/documentation/documentation/prompts/memory-indexer
---
...
```mermaid
graph LR
    A[dev] --> B[constraint-driven]
    B --> C[theatrical-testing]
    C --> D[psychic-debugging]
    D --> E[emergent-features]
````
