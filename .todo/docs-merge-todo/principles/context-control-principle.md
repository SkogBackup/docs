---
title: context-control-principle
type: note
permalink: skogai/docs-merge-todo/principles/context-control-principle
---
...
1. **Context Pollution**: Too much information clutters decision-making and creates noise
...
1. **Excluded Context**: Information that creates noise or asymmetry (dump.md)
1. **Shared Knowledge**: Insights both parties understand (knowledge/)
1. **Transfer Protocol**: Exact definitions for continuity (session.md)
