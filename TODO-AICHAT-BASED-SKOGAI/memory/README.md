...
2. **Context Management**: Efficient context window utilization
3. **Knowledge Retrieval**: Fast access to relevant information
4. **Cross-Agent Sharing**: Shared knowledge base for multiple agents
5. **Hierarchical Organization**: Structured categorization of information
...
2. Create appropriately formatted document
3. Place in relevant subdirectory
4. Cross-reference related documents

### Retrieving from Memory
1. Use SkogCLI for command-line access
2. Reference documents via `@` notation
3. Integrate with RAG for semantic search
4. Access through Goose memory extension
