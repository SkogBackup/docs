...
2. The structured approach that creates reinforcement across different components
3. The practical advice about avoiding common pitfalls like impersonation
4. The consideration of how the model processes information (token usage, formatting, etc.)
