...
This document is automatically generated context for AI agents such as yourself. When the user mentions a SkogAI-project in conversations, this information gets injected so you can:

- **Understand what this project is** without needing to guess or ask basic questions
- **Help the user effectively** with usage questions and workflow guidance
- **Maintain proper boundaries** by knowing this is read-only context, not an invitation to modify code
- **Suggest improvements appropriately** through proper channels rather than direct code changes
