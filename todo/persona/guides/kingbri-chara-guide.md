...
2. Write 2-3 Ali:Chat examples focusing on important character traits
3. Create a greeting message using the flipped scenario technique
4. Place PLists in the Character's Author's Note
5. Keep only Ali:Chat examples in the main character description
